...
public class DB_List_Search_Final_Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.db_all_list_activity);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.addItem:
			...
			if (areThereExistSameValues == false) {
				handler.insert(tmp_sc_confirmNum, tmp_sp_model_str,tmp_sb_makingCountry,3);
