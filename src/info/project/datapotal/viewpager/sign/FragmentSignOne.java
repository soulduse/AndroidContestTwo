...
public class FragmentSignOne extends Fragment{
	 ...
	 private JazzyGridView mGrid;
		...
		public View onCreateView(LayoutInflater inflater,
	        ...
	        mGrid.setOnScrollListener(new OnScrollListener() {
				...
				public void onScroll(AbsListView view, int firstVisibleItem,
					   ...
					   if(view.getAdapter() != null &&((firstVisibleItem + visibleItemCount) >= totalItemCount) && mLockListView == false)
					    {
					    	// URL to get contacts JSON
							String url = "http://www.ibtk.kr/publicAssistanceFigurecover_api/8f297146209d85a9502285f56f33c3f9?"+
											"model_query="+
											"%7B$or:%5B%7B%22code%22:%7B%22$regex%22:%271.1%27%7D%7D,"+
											"%7B%22code%22:%7B%22$regex%22:%271.2%27%7D%7D,"+
											"%7B%22code%22:%7B%22$regex%22:%271.3%27%7D%7D,"+
											"%7B%22code%22:%7B%22$regex%22:%271.4%27%7D%7D,"+
											"%7B%22code%22:%7B%22$regex%22:%271.5%27%7D%7D%5D%7D";
							if(pageNumber<=21)
							{
								getContacts(url);
							}
		...
		private class GetContacts extends AsyncTask<String, Void, Void> {
			...
			protected Void doInBackground(String... urls) {
				String URL = null;
				URL = urls[0];
				URL += "&model_query_pageable=%7B%27pageNumber%27:%27"+pageNumber+"%27%7D";
				pageNumber++;
