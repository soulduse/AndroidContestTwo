...
public class FragmentSignThree extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_danger_viewpager,
				container, false);
		...
		mGrid.setOnScrollListener(new OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if (view.getAdapter() != null
					...
					String url = "http://www.ibtk.kr/publicAssistanceFigurecover_api/8f297146209d85a9502285f56f33c3f9?model_query=%7B$or:%5B%7B%22code%22:%7B%22$regex%22:%272.200%27%7D%7D,%7B%22code%22:%7B%22$regex%22:%272.3%27%7D%7D%5D%7D";
	...
	private class GetContacts extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... urls) {
			...
			String URL = null;
			URL = urls[0];
			URL += "&model_query_pageable=%7B%27pageNumber%27:%27" + pageNumber
					+ "%27%7D";
			pageNumber++;
