...
public class FragmentSignfive extends Fragment{
			...
			mGrid.setOnScrollListener(new OnScrollListener() {
				...
				public void onScroll(AbsListView view, int firstVisibleItem,
					...
					if (view.getAdapter() != null
						...
						String url = "http://www.ibtk.kr/publicAssistanceFigurecover_api/8f297146209d85a9502285f56f33c3f9?model_query=%7B%22code%22:%7B%22$regex%22:%272.5%27%7D%7D";
						if(pageNumber<=1)
						{
							getContacts(url);
						}
